...
//        aliYunConfiguration.setAccessKeyId("LTAI4FmuqafdzNyCaiV3KNjb");
//        aliYunConfiguration.setAccessKeySecret("sEnndtMBvXfNMPkYIiHbTaTrwRSNVg");
//        aliYunConfiguration.setTemplateCode("SMS_186900515");
//        aliYunConfiguration.setSignName("能来能网");
//        TwilioSmsSender sender = new TwilioSmsSender("http://localhost:" + wireMockRule.port(), configuration, aliYunConfiguration);
//        boolean success = sender.deliverSmsVerification("15666828832", Optional.of("android-ng"), "123456").join();
//
...
//
//    @Test
//    public void testSendVox() throws ClientException {
...
//        aliYunConfiguration.setSignName("能来能网");
//        TwilioSmsSender sender = new TwilioSmsSender("http://localhost:" + wireMockRule.port(), configuration, aliYunConfiguration);
//        boolean success = sender.deliverVoxVerification("15666828832", "123456", Optional.of("en_US")).join();
//
//        assertThat(success).isTrue();
//
