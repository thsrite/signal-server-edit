...
import org.whispersystems.textsecuregcm.push.JiGuangPush;
...
public class GCMSenderTest {
  ...
  public void testSendMessage() {
    ...
    JpushConfiguration jpushConfiguration = new JpushConfiguration();
    jpushConfiguration.setAppkey("67d1886bd90b1580e54bdc44");
    jpushConfiguration.setSecret("a1da794b3fcac65e9dcf3ba4");
    GcmMessage message = new GcmMessage("1507bfd3f76f38f4d83", "+12223334444", 1, GcmMessage.Type.NOTIFICATION, Optional.empty());
    GCMSender gcmSender = new GCMSender(accountsManager, sender, executorService, new JiGuangPush(jpushConfiguration));
