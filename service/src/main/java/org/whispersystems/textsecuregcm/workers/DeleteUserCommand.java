...
public class DeleteUserCommand extends EnvironmentCommand<WhisperServerConfiguration> {
      ...
      throws Exception
  {
    try {
      ...
      //mq
      AMQPClient amqpClient = new AMQPClient(configuration.getAmqpConfiguration());
//      DirectoryQueue      directoryQueue  = new DirectoryQueue(configuration.getDirectoryConfiguration().getSqsConfiguration(),amqpClient);
